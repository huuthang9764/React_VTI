DROP DATABASE IF EXISTS `backend-react-VTI`;
CREATE DATABASE  `backend-react-VTI`;
USE `backend-react-VTI`;
...
CREATE TABLE IF NOT EXISTS `Keyboard`(
		...
		`brand` 				ENUM('LOGITECH', 'ASUS', 'AKKO') NOT NULL,
...
VALUES 				(	'user'		,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'base'	,	'USER'		,		'USER'		,		'2018-12-04'			),
